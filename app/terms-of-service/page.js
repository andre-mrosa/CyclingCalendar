  ...
  const sections = [
    {
      ...
      content: (
        <p className="text-slate-400 text-sm leading-relaxed">
          O <strong className="text-emerald-400">Cycling Calendar</strong> é um projeto não-comercial, criado e mantido de forma independente com o objetivo único de agregar e facilitar a consulta do calendário de provas de ciclismo em Portugal. <strong className="text-slate-300">Não somos organizadores</strong>, patrocinadores nem representantes de nenhum dos eventos listados.
        </p>
      ),
    },
    {
    ...
    },
    {
      ...
      content: (
        <div className="bg-rose-950/20 border border-rose-900/30 rounded-xl p-5 mt-2">
          <p className="text-slate-300 text-sm mb-3">Na máxima extensão permitida por lei, o Cycling Calendar <strong className="text-rose-400">não se responsabiliza por</strong>:</p>
    ...
    },
    {
      ...
      content: (
        <>
          <p className="text-slate-400 text-sm mb-4">Ao usar o Cycling Calendar, o utilizador concorda em:</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div className="p-4 bg-slate-900/40 rounded-xl border border-slate-800/40">
              ...
              <p className="text-slate-400">Usar a plataforma apenas para fins pessoais ou informativos.</p>
            </div>
            <div className="p-4 bg-slate-900/40 rounded-xl border border-slate-800/40">
              <span className="block text-rose-400 font-bold mb-1">Sem Abusos</span>
              <p className="text-slate-400">Não sobrecarregar os servidores com bots ou extração agressiva de dados (scraping abusivo).</p>
            </div>
            <div className="p-4 bg-slate-900/40 rounded-xl border border-slate-800/40">
              <span className="block text-emerald-400 font-bold mb-1">Identidade</span>
              <p className="text-slate-400">Não tentar fazer-se passar pela administração do site ou pelos organizadores.</p>
            </div>
            <div className="p-4 bg-slate-900/40 rounded-xl border border-slate-800/40">
              <span className="block text-rose-400 font-bold mb-1">Sistemas</span>
              <p className="text-slate-400">Não explorar ativamente vulnerabilidades de segurança.</p>
            </div>
          </div>
        </>
      ),
    ...
    <div className="min-h-screen bg-[#090d14] text-slate-200 antialiased selection:bg-emerald-500 selection:text-white py-12 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <header className="mb-12">
          <h1 className="text-4xl sm:text-5xl font-extrabold text-white mb-4 tracking-tight">Termos de <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400">Serviço</span></h1>
          <p className="text-lg text-slate-400 font-medium">As regras da casa e as condições de utilização da plataforma.</p>
        </header>
