...
export default function WelcomeModal() {
    ...
    return (
        <div 
            className="fixed inset-0 bg-black/75 backdrop-blur z-[99999] flex items-center justify-center p-3 sm:p-6 overflow-y-auto overscroll-contain"
            onClick={handleClose}
        >
            <div 
                className="bg-white dark:bg-slate-900 rounded-2xl w-full max-w-[550px] max-h-[88dvh] sm:max-h-[90vh] shadow-2xl relative border border-slate-200 dark:border-white/10 overflow-hidden flex flex-col my-auto animate-[fadeIn_0.3s_ease-out] text-slate-900 dark:text-slate-100 transition-colors duration-200"
            ...
            >
                ...
                <div className="pt-6 px-6 sm:pt-8 sm:px-8 pb-3.5 flex items-center gap-3.5 shrink-0 border-b border-slate-100 dark:border-slate-800/60">
                    <div className="bg-blue-500/10 p-2.5 sm:p-3 rounded-2xl text-blue-500 dark:text-blue-400 flex items-center justify-center border border-blue-500/20 shrink-0">
                            ...
                            <>
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                                    <input 
                                        ...
                                        className="p-2.5 sm:p-3 rounded-xl border border-slate-200 dark:border-slate-700/80 bg-white dark:bg-slate-900/60 text-slate-800 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 outline-none text-sm transition-colors focus:border-blue-500 disabled:opacity-50"
                                    />
                                    <input 
                                        type="email" 
                                ...
                                <textarea 
                                    ...
                                    disabled={isSubmitting}
                                    rows={3}
                                    className="p-2.5 sm:p-3 rounded-xl border border-slate-200 dark:border-slate-700/80 bg-white dark:bg-slate-900/60 text-slate-800 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 outline-none text-sm resize-y transition-colors min-h-[70px] focus:border-blue-500 disabled:opacity-50"
                                />
                                {submitStatus === 'error' && (
                                ...
                                <button 
                                    type="submit" 
                                    disabled={isSubmitting}
                                    className="w-full py-2.5 sm:py-3 px-4 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-semibold transition-colors shadow-lg shadow-blue-500/20 text-sm flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer"
                                >
                                    {isSubmitting ? (
                                        <>
                ...
                <div className="px-6 sm:px-8 py-3 sm:py-3.5 bg-slate-50 dark:bg-slate-950/60 border-t border-slate-200 dark:border-slate-800/80 flex justify-end shrink-0">
                    <button 
                        onClick={handleClose}
